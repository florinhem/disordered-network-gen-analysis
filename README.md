...
In the `python_order_metric_prediction` directory, you find the code to predict order metrics for networks generated from the initial __ctn__ network. Here, the workflow is demonstrated in the notebook `order_metric_prediction.ipynb`.
