...
spatial_networks_path = "../structures/neural_network_targeted/ctn/target_2/"
analysis_data_path = "../analysis_data/neural_network_targeted/ctn/target_2/"

NA.get_all_dicts_from_networks_multithreading(
spatial_networks_path,
analysis_data_path;
print_progress = true,
runs_vec = collect(1:34),
