...
#set path to files
load_path = raw"C:\Users\HemmannF\switchdrive\structure_analysis\code\binary_structes\\"

#include functions to load binary 3d data, convert and correct it and to extract
#some basic measures
include(load_path*"binary_structures/binary_structure_io_basics.jl")
...
#set path to files
load_path = raw"C:\Users\HemmannF\switchdrive\structure_analysis\code\networks\\"
